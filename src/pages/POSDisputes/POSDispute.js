...
import DisputeDetails from '../../components/posDisputes/DisputeDetails';
...
function Transactions() {
    ...
    const [disputeModalDetails, setDisputeModalDetails] = useState(null);
    ...
    const [openDisputeConfirmationModal, setOpenDisputeConfirmationModal] = useState(false);
    ...
    const localTransactions = [
        {
            ...
            amount: 2000,
            platformTransactionRef: 'ref12345',
            crustTransactionRef: 'ref123876',
            platform: 'Crust',
            createdAt: '2023-05-30T02:33:30.336Z',
            fee: 50,
            aggregatorCommission: 50,
    ...
    console.log({disputeDetails, transactionModalDetails, disputeModalDetails});
    ...
    return (
        <Main>
            ...
            {disputeModalDetails && (
                ...
                <DisputeDetails
                    ...
                    handleClose={() => {
                        ...
                        setDisputeModalDetails(null)}}
                    transaction={disputeModalDetails}
                    onClickConfirmDispute={() => {
                        setOpenDisputeConfirmationModal(true);
                        setDisputeDetails(false)
                    }}
                />
                </>
            )}
            ...
            />
            <ConfirmationModal
                open={openDisputeConfirmationModal}
                HeaderText={"Update Dispute"}
                ConfirmationBody={"Are you sure you want to update this dispute?"}
                confirmationText={"Yes, Confirm"}
                handleClose={() => setOpenDisputeConfirmationModal(false)}
                loading={reverseTransactionIsLoading}
                onClickConfirm={() => {
                    setOpenDisputeConfirmationModal(false)
